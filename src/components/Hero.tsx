  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white py-12 sm:py-16">
      <div className="container mx-auto px-4">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12 md:pt-5">
          <div className="text-left md:w-1/2">
            ...
            <p className="animate-slide-in mt-11 text-lg leading-8 text-gray-600">
